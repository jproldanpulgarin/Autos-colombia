...
<head>
    ...
    <!-- CSS only -->
    <link rel="shortcut icon" href="estilos/icono.ico" type="image/x-icon">
    ...
    <div>
            <nav class="barra_navegacion">
                <ul class="menu">
                    ...
                    <li><a href="INSERTAR.php">Ingresar Vehiculo</a> </li>
                    <li><a href="./inicio/BUSCAR.php"> Buscar Vehiculo</a> </li>
                    <li><a href="logout.php" onclick="alerta()">LogOut</a> </li>
                </ul>
            </nav>
        </div>
    <div class="row">
